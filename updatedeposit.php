    ...
    ?>
      ...
      if(isset($_POST['submit'])){
       ...
       $others=$_POST['others'];
                    ...
                    $query2="UPDATE addmember SET name='$name',address='$address',blood='$blood',rent='$rent',net='$net',gass='$gass',khala='$khala',current1='$current',water='$water',others='$others' WHERE phone='$phone' AND email='$email' ";
...
<nav class="navbar navbar-expand-md  navbar-dark mx-auto sticky-top " style="background: #F5F5F5;clear: both;" >
  ...
  <div class="collapse navbar-collapse " id="navbarNavDropdown">
    <ul class="navbar-nav ml-auto ">
      ...
      <?php };?>
       <li class="nav-item ">
        <a class="nav-link" href="schedule.php">Inbox<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item ">
        <a class="nav-link" href="schedule.php">Bazar Schedule <span class="sr-only">(current)</span></a>
      </li>
        <li class="nav-item ">
        <a class="nav-link" href="bazarcost.php">Bazar Cost <span class="sr-only">(current)</span></a>
      </li>
...
<div class="addform">
 ...
 <?php 
  ...
  $date2=$_GET['deleteB1'];
  echo$date2 ;
  $query1="SELECT*FROM bazarcost WHERE phone='$phone'  ";
 ...
 ?>
  ...
  <input class="form-control"  name="date1" value="<?php echo $row1['date1'];?>">
  </div>
  <div class="form-group">
    <label for="pwd">Bazar Cost</label>
  <input class="form-control"  name="amount" value="<?php echo $row1['amount'];?>">
  </div>
